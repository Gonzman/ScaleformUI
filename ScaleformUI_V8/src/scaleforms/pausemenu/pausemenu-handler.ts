...
export class PauseMenuHandler {
    ...
    addRightSettingsProgressItemAlt(
        tab: number,
        leftItemIndex: number,
        label: string,
        max: number,
