...
const enum TextFormat {
    HUD_COLOUR = "~HUD_COLOUR_...~",
    HC = "~HC_...~",
    HC_NUMBER = "~HC_[number]~",
    RESET = "~s~",
    SCRIPT_VARIABLE = "~v~",
    SCRIPT_VARIABLE_2 = "~u~",
    WHITE = "~w~",
    ...
    PLACEHOLDER_TEXT_INDEXED = "~a_X~",
    PLACEHOLDER_NUMBER_INDEXED = "~1_X~",
    UNKNOWN = "~x~",
    HIDDEN_SUBTITLES = "~z~",
    INPUT = "~INPUT_...~",
    INPUT_GROUP = "~INPUTGROUP_...~",
    ACCEPT = "~ACCEPT~",
    CANCEL = "~CANCEL~",
    PAD_UP = "~PAD_UP~",
    PAD_DOWN = "~PAD_DOWN~",
    ...
    PAD_DPAD_NONE = "~PAD_DPAD_NONE~",
    PAD_DPAD_ALL = "~PAD_DPAD_ALL~",
    PAD_DPAD_UPDOWN = "~PAD_DPAD_UPDOWN~",
    PAD_DPAD_LEFTRIGHT = "~PAD_DPAD_LEFTRIGHT~",
    PAD_LSTICK_UP = "~PAD_LSTICK_UP~",
    PAD_LSTICK_DOWN = "~PAD_LSTICK_DOWN~",
    PAD_LSTICK_LEFT = "~PAD_LSTICK_LEFT~",
    PAD_LSTICK_RIGHT = "~PAD_LSTICK_RIGHT~",
    PAD_LSTICK_NONE = "~PAD_LSTICK_NONE~",
    PAD_LSTICK_ALL = "~PAD_LSTICK_ALL~",
    PAD_LSTICK_UPDOWN = "~PAD_LSTICK_UPDOWN~",
    PAD_LSTICK_LEFTRIGHT = "~PAD_LSTICK_LEFTRIGHT~",
    PAD_LSTICK_ROTATE = "~PAD_LSTICK_ROTATE~",
    PAD_RSTICK_UP = "~PAD_RSTICK_UP~",
    PAD_RSTICK_DOWN = "~PAD_RSTICK_DOWN~",
    PAD_RSTICK_LEFT = "~PAD_RSTICK_LEFT~",
    PAD_RSTICK_RIGHT = "~PAD_RSTICK_RIGHT~",
    PAD_RSTICK_NONE = "~PAD_RSTICK_NONE~",
    PAD_RSTICK_ALL = "~PAD_RSTICK_ALL~",
    PAD_RSTICK_UPDOWN = "~PAD_RSTICK_UPDOWN~",
    PAD_RSTICK_LEFTRIGHT = "~PAD_RSTICK_LEFTRIGHT~",
    PAD_RSTICK_ROTATE = "~PAD_RSTICK_ROTATE~"
}

export { NotificationIcon, TextFormat };
